...
(function (global) {
    ...
    var MESSAGES = {
        en: {
            ...
            'login.leaveTitle': 'Leave Scholarius?',
            'login.leaveMessage': 'You will be taken to GitHub to authorize. Remember this code:\n\n{code}\n\nYou will need to enter it there.',
            'login.leaveConfirm': 'Continue',
        ...
        zh: {
            ...
            'login.leaveTitle': '离开 Scholarius？',
            'login.leaveMessage': '接下来会跳到 GitHub 授权。请记下这串码：\n\n{code}\n\n到那边要手动输入它。',
            'login.leaveConfirm': '继续',
